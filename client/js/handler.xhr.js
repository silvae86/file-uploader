...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _upload: function(id, params){
        ...
        {   
            ...
            var xhr = this._xhrs[id+"_"+i] = new XMLHttpRequest();
            xhrs[i] = xhr;
            ...
            xhr.onreadystatechange = function(){
                ...
                {
                    //hammer blow, i dont understand the code well enough to do better.
                    if(xhrs[j] != null && xhrs[j].readyState == 4)
                    {
                        self._onComplete(id+"_"+i, xhrs[j]);
                    }
                }
            };
            ...
            var queryString = qq.obj2url(params, array_endpoint[i]);
